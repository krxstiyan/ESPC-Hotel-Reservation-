...
gj.widget = function() {
        ...
        height: function(a, b) {
            ...
            return "border-box" === d.boxSizing ? c = parseInt(d.height, 10) : (c = parseInt(d.height, 10), c += parseInt(d.paddingTop || 0, 10) + parseInt(d.paddingBottom || 0, 10), c += parseInt(d.borderTop || 0, 10) + parseInt(d.borderBottom || 0, 10)), b && (c += parseInt(d.marginTop || 0, 10) + parseInt(d.marginBottom || 0, 10)), c
        },
        width: function(a, b) {
            var c, d = window.getComputedStyle(a);
            return "border-box" === d.boxSizing ? c = parseInt(d.width, 10) : (c = parseInt(d.width, 10), c += parseInt(d.paddingLeft || 0, 10) + parseInt(d.paddingRight || 0, 10), c += parseInt(d.borderLeft || 0, 10) + parseInt(d.borderRight || 0, 10)), b && (c += parseInt(d.marginLeft || 0, 10) + parseInt(d.marginRight || 0, 10)), c
        },
        ...
        position: function(a, b, c) {
            var d = a.getBoundingClientRect(),
                ...
                h = window.pageYOffset || g.scrollTop || e.scrollTop,
                i = window.pageXOffset || g.scrollLeft || e.scrollLeft,
                j = g.clientTop || e.clientTop || 0,
                k = g.clientLeft || e.clientLeft || 0,
                l = Math.round(d.top + h - j),
                m = Math.round(d.left + i - k);
            return b && (l += parseInt(f.paddingTop || 0, 10), m += parseInt(f.paddingLeft || 0, 10)), c && (l += parseInt(f.marginTop || 0, 10), m += parseInt(f.marginLeft || 0, 10)), {
                top: l,
                left: m,
                bottom: l + gj.core.height(a),
                right: m + gj.core.width(a)
            }
        }
    }, gj.dialog = {
        plugins: {},
    ...
    function(a) {
        ...
        move: function(a, b, c, d, e, f) {
            var g, h, i, j = gj.core.position(a),
                k = j.top + d,
                l = j.left + c;
            b.containment && (g = gj.core.position(b.containment), h = g.top + gj.core.height(b.containment) - gj.core.height(a), i = g.left + gj.core.width(b.containment) - gj.core.width(a), k > g.top && k < h ? (g.top >= f || g.bottom <= f) && (k = j.top) : k = k <= g.top ? g.top + 1 : h - 1, l > g.left && l < i ? (g.left >= e || g.right <= e) && (l = j.left) : l = l <= g.left ? g.left + 1 : i - 1), !1 !== gj.draggable.events.drag($(a), k, l, e, f) && (a.style.top = k + "px", a.style.left = l + "px")
        },
        destroy: function(a) {
    ...
    function(a) {
        ...
        editMode: function(a, b, c, d) {
            ...
            }))), "INPUT" === g.prop("tagName").toUpperCase() && "TEXT" === g.prop("type").toUpperCase() ? gj.grid.plugins.inlineEditing.private.setCaretAtEnd(g[0]) : g.focus(), b.attr("data-mode", "edit")) : "managementColumn" === c.role && (b.find('[role="edit"]').hide(), b.find('[role="delete"]').hide(), b.find('[role="update"]').show(), b.find('[role="cancel"]').show()))
        },
        ...
        public: {
            getCSV: function(a) {
                var b, c, d = "",
                    ...
                    g = this.getAll(a);
                if (g.length) {
                    for (b = 0; b < f.length; b++) !0 !== f[b].hidden && (d += '"' + (f[b].title || f[b].field) + '",');
        ...
        getRecords: function(a, b) {
            var c, d, e, f = [],
                g = a.data();
            for (c = 0; c < b.length; c++) d = g.primaryKey && b[c][g.primaryKey] ? b[c][g.primaryKey] : g.autoGenId++, e = {
                id: d,
                data: b[c]
        ...
        getAll: function(a, b) {
            ...
            for (c = 0; c < b.length; c++) d = JSON.parse(JSON.stringify(b[c].data)), b[c].children.length && (d[f] = gj.tree.methods.getAll(a, b[c].children)), e.push(d);
            return e
        },
    ...
    function(a) {
        ...
        prev: function(a, b) {
            return function() {
                ...
                switch (h.attr("type")) {
                    case "month":
                        d = parseInt(h.attr("month"), 10), e = parseInt(h.attr("year"), 10), c = gj.datepicker.methods.getPrevMonth(d, e), h.attr("month", c.month), h.attr("year", c.year), gj.datepicker.methods.renderMonth(a, h, b);
                        break;
                    case "year":
                        e = parseInt(h.attr("year"), 10), h.attr("year", e - 1), gj.datepicker.methods.renderYear(a, h, b);
                        break;
                    case "decade":
                        e = parseInt(h.attr("year"), 10), f = e - e % 10, h.attr("year", f - 10), gj.datepicker.methods.renderDecade(a, h, b);
                        break;
                    case "century":
                        e = parseInt(h.attr("year"), 10), g = e - e % 100, h.attr("year", g - 100), gj.datepicker.methods.renderCentury(a, h, b)
                }
            }
        },
        next: function(a, b) {
            return function() {
                ...
                switch (h.attr("type")) {
                    case "month":
                        d = parseInt(h.attr("month"), 10), e = parseInt(h.attr("year"), 10), c = gj.datepicker.methods.getNextMonth(d, e), h.attr("month", c.month), h.attr("year", c.year), gj.datepicker.methods.renderMonth(a, h, b);
                        break;
                    case "year":
                        e = parseInt(h.attr("year"), 10), h.attr("year", e + 1), gj.datepicker.methods.renderYear(a, h, b);
                        break;
        ...
        open: function(a, b) {
            ...
            c.show(), c.closest('div[role="modal"]').show(), b.modal ? gj.core.center(c) : (gj.core.setChildPosition(a[0], c[0]), a.focus()), clearTimeout(a.timeout), gj.datepicker.events.open(a)
        },
        close: function(a) {
        ...
        value: function(a, b) {
            var c, d, e = a.data();
            return void 0 === b ? a.val() : (d = gj.core.parseDate(b, e.format, e.locale), d ? (c = $("body").find('[role="calendar"][guid="' + a.attr("data-guid") + '"]'), gj.datepicker.methods.dayClickHandler(a, c, e, d)()) : a.val(""), a)
        },
        destroy: function(a) {
            var b = a.data(),
                c = a.parent(),
    ...
    function(a) {
        ...
        init: function(a) {
            return gj.widget.prototype.init.call(this, a, "timepicker"), this.attr("data-timepicker", "true"), gj.timepicker.methods.initialize(this, this.data()), gj.timepicker.methods.createClock(this), this
        },
        initialize: function(a, b) {
            var c, d = a.parent('div[role="wrapper"]');
            c = "bootstrap" === b.uiLibrary ? $('<span class="input-group-addon">' + b.icons.rightIcon + "</span>") : "bootstrap4" === b.uiLibrary ? $('<span class="input-group-append"><button class="btn btn-outline-secondary border-left-0 border" type="button">' + b.icons.rightIcon + "</button></span>") : $(b.icons.rightIcon), c.attr("role", "right-icon"), 0 === d.length ? (d = $('<div role="wrapper" />').addClass(b.style.wrapper), a.wrap(d)) : d.addClass(b.style.wrapper), d = a.parent('div[role="wrapper"]'), b.width && d.css("width", b.width), a.val(b.value).addClass(b.style.input).attr("role", "input"), "bootstrap" === b.uiLibrary || "bootstrap4" === b.uiLibrary ? "small" === b.size ? (d.addClass("input-group-sm"), a.addClass("form-control-sm")) : "large" === b.size && (d.addClass("input-group-lg"), a.addClass("form-control-lg")) : "small" === b.size ? d.addClass("small") : "large" === b.size && d.addClass("large"), c.on("click", function(b) {
                $("body").find('[role="clock"][guid="' + a.attr("data-guid") + '"]').is(":visible") ? gj.timepicker.methods.close(a) : gj.timepicker.methods.open(a)
            }), !1 === b.footer && a.on("blur", function() {
                a.timeout = setTimeout(function() {
        ...
        open: function(a) {
            ...
            return b = a.value() ? gj.core.parseDate(a.value(), d.format, d.locale) : new Date, c = b.getHours(), "ampm" === d.mode && e.attr("mode", c > 12 ? "pm" : "am"), e.attr("hour", c), e.attr("minute", b.getMinutes()), gj.timepicker.methods.renderHours(a, e, d), e.show(), e.closest('div[role="modal"]').show(), d.modal ? gj.core.center(e) : (gj.core.setChildPosition(a[0], e[0]), a.focus()), gj.timepicker.events.open(a), a
        },
        close: function(a) {
    ...
    function(a) {
        ...
        createMouseMoveHandler: function(a, b, c, d, e) {
            return function(d) {
                var f, g, h, i, j, k, l;
                "true" === c.getAttribute("drag") && (f = gj.core.position(a[0], !0, !0), g = (new gj.widget).mouseX(d) - f.left, h = gj.core.width(b), i = gj.core.width(c) / 2, j = h / (e.max - e.min), k = (e.value - e.min) * j, g >= i && g <= h + i && (g > k + j / 2 || g < k - j / 2) && (l = Math.round((g - i) / j) + e.min, gj.slider.methods.value(a, e, l)))
            }
        },
